...
public class DefaultThemeManager implements ThemeManager {
    ...
    public Theme getTheme(String name, Theme.Type type) {
        ...
        System.out.println("*****************");
        System.out.println("Profile.isFeatureEnabled(Profile.Feature.ACCOUNT2)=" + Profile.isFeatureEnabled(Profile.Feature.ACCOUNT2));
        System.out.println("isAccount2Enabled=" + isAccount2Enabled);
        System.out.println("theme.getName()=" + theme.getName());
        System.out.println("****************");
