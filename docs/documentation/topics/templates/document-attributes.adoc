...
:uicustomizationguide_name: UI Customization Guide
:uicustomizationguide_name_short: UI Customization
:uicustomizationguide_link: {project_doc_base_url}/ui_customization/
:uicustomizationguide_link_latest: {project_doc_base_url_latest}/ui_customization/
:uicustomizationguide_deploying_themes: {uicustomizationguide_link}#deploying-themes
