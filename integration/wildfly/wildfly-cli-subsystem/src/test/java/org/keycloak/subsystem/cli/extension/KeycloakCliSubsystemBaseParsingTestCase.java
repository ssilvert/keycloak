 ...
 */
public class KeycloakCliSubsystemBaseParsingTestCase extends AbstractSubsystemBaseTest {

    public KeycloakCliSubsystemBaseParsingTestCase() {
    ...
    protected String getSubsystemXml() throws IOException {
        return "<subsystem xmlns=\"" + KeycloakCliSubsystemExtension.NAMESPACE + "\">" +
                "</subsystem>";
    }
