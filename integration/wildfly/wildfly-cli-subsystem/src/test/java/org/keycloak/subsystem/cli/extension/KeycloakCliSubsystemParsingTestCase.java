 ...
 */
public class KeycloakCliSubsystemParsingTestCase extends AbstractSubsystemTest {

    public KeycloakCliSubsystemParsingTestCase() {
        super(KeycloakCliSubsystemExtension.SUBSYSTEM_NAME, new KeycloakCliSubsystemExtension());
    }
    ...
    public void testParseSubsystem() throws Exception {
        ...
        String subsystemXml =
                "<subsystem xmlns=\"" + KeycloakCliSubsystemExtension.NAMESPACE + "\">" +
                        "</subsystem>";
        ...
        Assert.assertEquals(KeycloakCliSubsystemExtension.SUBSYSTEM_NAME, element.getValue());
    }
    ...
    public void testInstallIntoController() throws Exception {
        ...
        Assert.assertTrue(model.get(SUBSYSTEM).hasDefined(KeycloakCliSubsystemExtension.SUBSYSTEM_NAME));
    }
